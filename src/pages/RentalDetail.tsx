...
export default function RentalDetail() {
  ...
  const { data: property, isLoading } = useQuery({
    queryKey: ['rental-unit', propertyId],
    queryFn: () => rentalApi.getById(propertyId),
    enabled: !!propertyId,
  });
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500">物件詳細</p>
          </div>
        </div>
        <div className="flex gap-2">
            <Button onClick={() => navigate(`/rental/${propertyId}/edit`)}>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <div className="text-3xl font-bold text-[#5AB9CE]">
              ...
              <div className="space-y-2 text-sm border-t pt-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">¥{property.key_money?.toLocaleString()}</span>
                </div>
              </div>
            </CardContent>
          </Card>
